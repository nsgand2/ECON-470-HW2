...
########################################################################################
for (i in 1998:2011) {
  HCRIS.alpha=read_csv(paste0("C:/Users/Nikhita Gandhe/Documents/GitHub/ECON-470-HW2/data/input/Version_1996/HospitalFY",i,"/hosp_",i,"_ALPHA.CSV"),
                       col_names=c('RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'))
  HCRIS.numeric=read_csv(paste0("C:/Users/Nikhita Gandhe/Documents/GitHub/ECON-470-HW2/data/input/Version_1996/HospitalFY",i,"/hosp_",i,"_NMRC.CSV"),
                         col_names=c('RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'))
  HCRIS.report=read_csv(paste0("C:/Users/Nikhita Gandhe/Documents/GitHub/ECON-470-HW2/data/input/Version_1996/HospitalFY",i,"/hosp_",i,"_RPT.CSV",sep=""),
...
write_rds(final.hcris.v1996,'C:/Users/Nikhita Gandhe/Documents/GitHub/ECON-470-HW2/data/output/HCRIS_Data_v1996.rds')
